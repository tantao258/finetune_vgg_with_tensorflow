...
class VGG19(object):
    def __init__(self, keep_prob, num_classes, train_layers, learning_rate=0.01, model="train", weights_path='DEFAULT'):
       ...
       """
        ...
        conv3_4 = conv(conv3_3, 3, 3, 256, 1, 1, name="conv3_4")   # 比vgg16多的一层
        ...
        conv4_4 = conv(conv4_3, 3, 3, 512, 1, 1, name="conv4_4")   # 比vgg16多的一层
        ...
        conv5_4 = conv(conv5_3, 3, 3, 512, 1, 1, name="conv5_4")     # 比vgg16多的一层
